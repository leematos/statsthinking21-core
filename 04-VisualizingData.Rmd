...
```{r gasPrices,echo=FALSE,message=FALSE, warning=FALSE,fig.cap="The price of gasoline in the US from 1930 to 2001 (obtained from http://www.thepeoplehistory.com/70yearsofpricechange.html) with or without correction for inflation (based on Consumer Price Index).",fig.width=4,fig.height=4,out.height='50%'}
